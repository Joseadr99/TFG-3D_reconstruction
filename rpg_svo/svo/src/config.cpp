...
Config::Config() :
    ...
    grid_size(vk::getParam<int>("svo/grid_size", 10)),
    init_min_disparity(vk::getParam<double>("svo/init_min_disparity", 10.0)),
    ...
    reproj_thresh(vk::getParam<double>("svo/reproj_thresh", 10.0)),
    poseoptim_thresh(vk::getParam<double>("svo/poseoptim_thresh", 5.0)),
    ...
    triang_half_patch_size(vk::getParam<int>("svo/triang_half_patch_size", 15)),
    subpix_n_iter(vk::getParam<int>("svo/subpix_n_iter", 10)),
    max_n_kfs(vk::getParam<int>("svo/max_n_kfs", 0)),
    img_imu_delay(vk::getParam<double>("svo/img_imu_delay", 0.0)),
    max_fts(vk::getParam<int>("svo/max_fts", 120)),
    quality_min_fts(vk::getParam<int>("svo/quality_min_fts", 20)),
